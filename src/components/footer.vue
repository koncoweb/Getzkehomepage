      ...
      <div class="footer-copyright">
        <span class="footer-text17">
          <span>
            <span>
              © All rights reserved
              <span v-html="rawuvrt"></span>
            </span>
            <span><span v-html="rawcm5d"></span></span>
          </span>
          <a
          ...
          <span>
            <span>
              Powered by
              <span v-html="rawlrdi"></span>
            </span>
            <span><span v-html="raw4uv8"></span></span>
          </span>
          <a
          ...
          <span>
            <span>
              . Image source:
              <span v-html="rawdp1s"></span>
            </span>
            <span><span v-html="raw0cq4"></span></span>
          </span>
          <a
